...
def execute_super(task=None):
    ...
    class Dir(SuperDirector):
        DIRECTOR_ID="rowan_blake"
        DIRECTOR_NAME="Rowan Blake"
        DIRECTOR_TITLE="Director"
        PERSPECTIVES=['thiel_network', 'blue_ocean', 'hoffman_blitz', 'ansoff_growth']
    ...
    return d.execute_full(task,parallel_perspectives=['thiel_network', 'blue_ocean', 'hoffman_blitz', 'ansoff_growth'],chain_steps=3,rank_criteria="partnership_revenue")
