...
## READY FOR UPLOAD (10 Titles)

### 1. 90-Day Goal Planner
- **Upload File:** `90_Day_Goal_Planner_FULL.pdf` (229 KB) ✅ Full version
- **Alt File:** `90-Day_Goal_Planner.pdf` (8.7 KB — stub only)
...
- **Alt File:** `Monthly_Budget_Planner_Finance_Tracker.pdf` (9 KB — stub only)
- **Desktop Backup:** `UPLOAD_THIS_BUDGET_PLANNER.pdf` (139 KB)
- **Paperback Price:** $7.99
- **Kindle Price:** $2.99
...
- **Alt File:** `Business_Plan_Template_Annual.pdf` (30 KB)
...
- **Alt File:** `Word_Search_Puzzles_100_Puzzles.pdf` (18 KB)
- **Paperback Price:** $7.99
- **Kindle Price:** $2.99
...
- **Alt File:** `Gratitude_Journal_365_Days.pdf` (18 KB)
- **Paperback Price:** $7.99
- **Kindle Price:** $2.99
...
- **Alt File:** `Password_Keeper_Log_Book.pdf` (30 KB)
...
- **Alt File:** `Sudoku_Puzzles_200_Easy_to_Hard.pdf` (18 KB)
- **Paperback Price:** $7.99
- **Kindle Price:** $2.99
...
## ADDITIONAL RESOURCES ON DESKTOP
- `C:\Users\S\Desktop\UPLOAD_THIS_TO_KDP.pdf` (224 KB) — generic KDP-ready PDF
- `C:\Users\S\Desktop\UPLOAD_THIS_BUDGET_PLANNER.pdf` (139 KB) — budget planner variant
