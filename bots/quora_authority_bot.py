...
def write_answer(question_data: dict) -> str:
    if not ANTHROPIC_KEY:
        return (
            "Great question. I've tested most methods in this space extensively.\n\n"
            "The honest answer: most passive income methods fail because people try to start "
            "too many things simultaneously instead of systematically building one channel at a time.\n\n"
            "Here's what actually works in 2026:\n\n"
            "**Start with digital products** -- Create a PDF, template, or guide once. List it on "
            "Gumroad or Etsy. This is genuinely zero ongoing work after setup. We have 10 products "
            "generating sales 24/7 with no involvement from us.\n\n"
            "**Stack bandwidth sharing** -- Honeygain, Traffmonetizer, and Pawns.app run on any "
            "computer or VPS. Combined they generate $40-80/month per device doing absolutely nothing. "
            "Not life-changing alone, but it's the foundation -- money coming in while you build bigger channels.\n\n"
            "**Build the content engine** -- A blog + newsletter combination takes 3-6 months to "
            "generate meaningful traffic but then compounds forever. The key is consistency, which is "
            "why most people fail. We automated ours entirely using AI tools. It now publishes daily "
            "without manual work.\n\n"
            "We document all of this at nyspotlightreport.com if you want the detailed breakdown "
            "of the exact stack.\n\n"
            "The one thing I'd tell you: start with the lowest-friction method (bandwidth sharing, "
            "digital products) to see money come in quickly, then build the compounding channels "
            "while that small income covers your tools.\n\n"
